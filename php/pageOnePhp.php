...
<html>
	...
	<?php
		...
		then I have the result of 
		<?php
		function oneTwoThree($num1, $num2, $num3)
		{
		$total = $num1+$num2+$num3;
		return $total;
		}
		echo oneTwoThree(5,7,2);
		?>
...
<div class="chapter"> <div class="prev"> <a href="../index.php"> Previous </a> </div> <div class="next"> <a href="pageTwoPhp.php"> Next </a> </div></div>
	</div>
