<?php include "../templates/top.php"?>
	...
	test that the decisions that you hold are correct indeed are.</br>
	That has prompt me to think about assumptions that we take while testing. </br></br>
	An assumption is something that we believe to be true and that we think will hold true in light of certain condition. I am not saying that this is wrong, but after a while the 	assumption will become an habit, something that you no longer know to be an assumption but you hold it as the "truth".	
	What is the risk in doing so? Well first and foremost if an assumption becomes normality we'll start to lean on it and the fall will be more painful
	Second, you will become blind to that assumption and you'll not be able to see it any longer for what really is.	
	...
	I assume, giving my knowledge of the area, my past experience and the map that I looked at before doing the first journey that route X1 is the quickest.
	...
	bike via that different route. Most of the time though testing your assumption will only cause you to waste time and effort and you'll end up getting to 
	point B late, but in the process you'll have gained two important insights. First, your initial assumption was correct, route X1 is quickest. Second you'll
	have learned a new way to go from point A to point B that it might be useful in the future. And third, a different route means that you are zooming out 
	from your usual routine and therefore tomorrow when you'll go trough the same most efficient old way, you'll look at it with different eyes. </br></br>
